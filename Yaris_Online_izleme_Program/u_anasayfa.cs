...
namespace Yaris_Online_izleme_Programı
{
    public partial class u_anasayfa : UserControl
    {
        ...
        public static bool Programclose1;
        ...
        public u_anasayfa()
        {
            ...
            excelDataSource1.FileName = @"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\HATALAR\\" + "HATA_LOG" + ".csv";
        ...
        private void tmrCheck_Tick(object sender, EventArgs e)
        {
            ...
            M_Pres_1_Kalite_Onay_Bekleniyor = Anasayfa.getBitStateByte(Anasayfa.readBool[2], 7);    //db1 BİT 2.7    21
             ...
             //   barkodtext.Text = M_Pres_1_Barkod_Okuma_Sipariş_No.ToString();


             //5  if (barkodtext.Text == "")
             //5  {
             //5      barkodtext.Text = "0";
             //5  }
             //5
             //5  if ((M_Pres_1_Barkod_Okuma_Sipariş_No == 0) && (txt_Null_1 == "txt_Null_1"))
             //5  {
             //5      txt_Null_1 = "";
             //5      barkodtext.Text = "0";
             //5  }
             //5  else if (((M_Pres_1_Barkod_Okuma_Sipariş_No != 0) && (txt_Null_1 == "txt_Null_1")))
             //5  {
             //5      txt_Null_1 = "";
             //5      barkodtext.Text = M_Pres_1_Barkod_Okuma_Sipariş_No.ToString();
             //5  }
            ...
            {
                MessageBox.Show("Plc Değişken Veri Okuma Yazma Error11");
                Programclose = true;
            }
        }
        ...
        void mesajEkle(int hataID)
        {
            ...
            if (hataKontrol[hataID] == false)
            {
               ...
               // File.AppendAllText(System.IO.Directory.GetCurrentDirectory() + "\\HATALAR\\" + "HATA_LOG" + ".csv", yazi); 
                File.AppendAllText(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\HATALAR\\" + "HATA_LOG" + ".csv", yazi);
        ...
        {      
            ...
            int lenght = (M_Pres_1_Barkod_Okuma_Sipariş_Panel.ToString()).Length;
            try
            {
                // string[] lineokutulanürün = File.ReadAllLines(Directory.GetCurrentDirectory() + "\\ÜrünOkunan\\" + "OkutulanSiparis" + ".txt");
                string[] lineokutulanürün = File.ReadAllLines(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\ÜrünOkunan\\" + "OkutulanSiparis" + ".txt");
                ...
                string[] linekayıtlıürün = File.ReadAllLines(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\ÜrünKayıt\\" + "KayıtEdilecekSiparis" + ".txt");
           ...
           catch
           {
            ...
            //       if (barkodtext.Text != "")
            //   {
            //       if (M_Pres_1_Barkod_Okuma_Sipariş_Panel != (Convert.ToInt32(barkodtext.Text)))
            //       {
            //
            //              // string[] lines = File.ReadAllLines(Directory.GetCurrentDirectory() + "\\ÜRÜNLER\\" + "ÜrünNumaraları" + ".txt");
            //               string[] lines = File.ReadAllLines(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\ÜRÜNLER\\" + "ÜrünNumaraları" + ".txt");
            //               int countd = lines.Count();
            //
            //            //7 for (int i = 0; i < countd; i++)
            //            //7 {
            //            //7     if (barkodtext.Text == lines[i])
            //            //7     {
            //            //7         SiparişEşleşmeOk = true;
            //            //7         barkodtext.BackColor = Color.White;
            //            //7         Anasayfa.writeBit(1, 0, 0, 1);  //barkod okuma yapıldı
            //            //7         txt_Null_4 = "txt_Null_4";
            //            //7     }
            //            //7
            //            //7 }
            //            //7    
            //            //7     
            //            //7     if (txt_Null_4 == "txt_Null_4" && SiparişEşleşmeOk == false)
            //            //7     {
            //            //7         txt_Null_4 = "";
            //            //7         Anasayfa.writeBit(1, 0, 0, 0);  //barkod okuma yapıldı  
            //            //7     if (barkodtext.Text!="0")
            //            //7     {
            //            //7         MessageBox.Show("SİPARİŞ NUMARASI TANIMSIZ", "SİPARİŞ BARKOD OKUTMA", MessageBoxButtons.OK);
            //            //7     }
            //            //7        
            //            //7
            //            //7     }
            //            //7 
            //            //7 M_Pres_1_Barkod_Okuma_Sipariş_Panel = (Convert.ToInt32(barkodtext.Text));
            //
            //       }
            //       else
            //       {
            //          //7 txt_Null_4 = "txt_Null_4";
            //          //7 SiparişEşleşmeOk = false;
            //       }
            //   }
            //   }
            //   catch
            ...
            //       barkodtext.BackColor = Color.Tomato;
            //   }
            //6   if ((M_Pres_1_Barkod_Okuma_Sipariş_No != M_Pres_1_Barkod_Okuma_Sipariş_Panel) && lenght <= 15 && txt_Null_2 == "txt_Null_2")
            //6   {
            //6       txt_Null_2 = "";
            //6       M_Pres_1_Barkod_Sipariş_No_Okutma_Zamanı = DateTime.Now;
            //6   }           
            //6   else
            //6   {
            //6       txt_Null_2 = "txt_Null_2";
            //6   }
            //6  
            //6
            //6   if (lenght > 15)
            //6   {
            //6       MessageBox.Show("Barkod okutma degeri çok yüksek");
            //6   }
            //6
            //6
            //6   if ((M_Pres_1_Barkod_Okuma_Sipariş_No != M_Pres_1_Barkod_Okuma_Sipariş_Panel) && lenght <= 15)
            //6   {
            //6       M_Pres_1_Barkod_Okuma_Sipariş_No = M_Pres_1_Barkod_Okuma_Sipariş_Panel;
            //6   }



            digitalGauge8.Text = barkodtext.Text;
            digitalGauge1.Text =M_Pres_1_Basılan_Parça_Adedi.ToString();
            //6  VALUESDint1[0] = M_Pres_1_Barkod_Okuma_Sipariş_No;
            //6  Anasayfa.writedint(100, VALUESDint1);//barkod okuma sipariş no  
            //6  if (barkodtext.Text!= "0")
            //6  {               
            //6      barkodtext.SelectAll();
            //6  }
      ...
      // }
       ...
       // }
        ...
        private void u_anasayfa_Load(object sender, EventArgs e)
        {
           ...
           string[] liner = File.ReadAllLines(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\Kullanıcılar\\" + "AktifKullanıcı" + ".txt");
         ...
         // hatalar = File.ReadAllLines(System.IO.Directory.GetCurrentDirectory() + "\\HATALAR\\" + "HATA" + ".txt");
          hatalar = File.ReadAllLines(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\HATALAR\\" + "HATA" + ".txt");
          timer1.Enabled = true;
          int i;
          for (i = 0; i < countrt; i++)
          {
         ...
         //   M_Pres_1_Makina_Performansı = M_Pres_1_iş_toplam_zaman-M_Pres_1_Kalite_Onay_Toplam_Zaman-M_Pres_1_WC_Toplam_Zaman-M_Pres_1_Setup_Toplam_Zaman-M_Pres_1_Parça_Bekleme_Toplam_Zaman-M_Pres_1_Kalite_Onay_Toplam_Zaman;
          ...
          if (M_Pres_1_Parça_Basılması_Bekleniyor==true)
            ...
            if (Anasayfa.actPage == "u_anasayfa")
            {
                if  ( txt_Null_3=="txt_Null_3")
                {
                    try
                    {
                       ...
                       // StreamReader sr = new System.IO.StreamReader(Directory.GetCurrentDirectory() + "\\Kullanıcılar\\" + "AktifKullanıcı" + ".txt");
                        StreamReader sr = new System.IO.StreamReader(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\Kullanıcılar\\" + "AktifKullanıcı" + ".txt");
             ...
             //3  try
             //3  {
             //3     if (listView1.Items.Count>0 )
             //3      {
             //3          if (u_anasayfa.M_Pres_1_iş_başlat == false)
             //3
             //3          {
             //3              //StreamWriter writerr = new StreamWriter(Directory.GetCurrentDirectory() + "\\Kullanıcılar\\" + "AktifKullanıcı" + ".txt");
             //3              StreamWriter writerr = new StreamWriter(@"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\" + "\\Kullanıcılar\\" + "AktifKullanıcı" + ".txt");
             //3            
             //3              writerr.WriteLine("");
             //3              writerr.Close();
             //3          }
             ...
             //3  catch
             //3  {
             //3      MessageBox.Show("OPERATÖR LİSTESİ SİLİNEMİYOR");
             //3  }
            }
