...
namespace Yaris_Online_izleme_Programı
{
    public partial class Anasayfa : Form
    {
        ...
        private void Anasayfa_Load(object sender, EventArgs e)
        {
            ...
            frmForm1.ShowDialog();
            tarihGuncelle();
         //   DosyaYolu = @"\\192.168.16.110\Users\Public\pres online izleme pres\Debug\";
            ...
            btnSetting.BackColor = Color.Goldenrod;
        ...
        private void HaberleşmeDurumu_Click(object sender, EventArgs e)
        {

        }

        private void ModDurumu_Click(object sender, EventArgs e)
        {
